    ...
    <div className="w-64 bg-background border-r border-border flex flex-col h-screen">
      ...
      <div className="p-4 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-foreground">AETHEL</h2>
      ...
      <div className="flex-1 overflow-y-auto p-3">
        {/* Trading Interface */}
        <div className="mb-6">
          <h3 className="text-muted-foreground text-xs font-medium mb-3 px-2 uppercase tracking-wider">Trading Interface</h3>
            ...
            {tradingModules.map((module) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-all text-left text-sm font-medium ${
        ...
        {/* Quantum AI Core */}
        <div className="mb-6">
          <h3 className="text-muted-foreground text-xs font-medium mb-3 px-2 uppercase tracking-wider">Quantum AI Core</h3>
          <div className="space-y-1">
        ...
        {/* AI Trading Bots */}
        <div className="mb-6">
          <h3 className="text-muted-foreground text-xs font-medium mb-3 px-2 uppercase tracking-wider">AI Trading Bots</h3>
          <div className="space-y-1">
        ...
        {/* System Core */}
        <div>
          <h3 className="text-muted-foreground text-xs font-medium mb-3 px-2 uppercase tracking-wider">System Core</h3>
          <div className="space-y-1">
